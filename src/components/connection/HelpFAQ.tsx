...
const faqs = [
  {
    question: "Como pego minha chave do Gemini?",
    answer:
      'Acesse aistudio.google.com, faça login com sua conta Google, clique em "Get API Key" e depois em "Create API Key". Copie a chave gerada (ela começa com "AIza") e cole no Passo 1 da configuração. A chave é gratuita para uso moderado.',
  },
  {
    question: "O robô não está respondendo no WhatsApp, o que faço?",
    answer:
      "Verifique 3 coisas: 1) Se a chave do Gemini ainda é válida (pode ter atingido o limite de cota). 2) Se o webhook está ativo e a URL está correta. 3) Na aba de Logs, veja se há erros recentes de envio. Se tudo estiver correto, desative e reative o agente.",
  },
  {
  ...
  {
    question: "A chave do Gemini tem custo?",
    answer:
      "O Google oferece um nível gratuito generoso para o Gemini. Para a maioria dos negócios pequenos, o uso fica dentro do limite gratuito. Caso ultrapasse, o custo é bem acessível. Acompanhe seu consumo em aistudio.google.com.",
  },
];
